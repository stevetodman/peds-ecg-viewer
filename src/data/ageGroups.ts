...
export const AGE_GROUPS: readonly AgeGroup[] = [
  ...
  },
  {
    ...
    maxDays: 3,
    stage: 'neonate',
    clinicalNotes: 'Transitional period. T-wave in V1 inverting. Upright T still acceptable.',
  },
  {
    id: 'neonate_3_7d',
    label: '3-7 days',
    ...
    maxDays: 8,
    stage: 'neonate',
    clinicalNotes: 'T-wave in V1 should be inverted. Upright T suggests RVH.',
  },
  {
    id: 'neonate_8_30d',
    label: '8-30 days',
